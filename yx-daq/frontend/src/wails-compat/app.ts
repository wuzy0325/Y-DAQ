import { CalibrationService, ConfigService, DataService, DeviceService, FiveHoleService, MotionService, ThreeHoleService } from './services'
import type { AxisName, CalibrationConfig, DeviceProfile, MotionControllerProfile, ThreeHoleTraversalConfig } from './types'
import type { FiveHoleTraversalConfig } from '@bindings/yx-daq/internal/types/models'
...
// 五孔测试：单实例，方法不接 probeID（probeID 仅在按探针载入校准时使用）
export const OpenFiveHoleTestWindow = () => FiveHoleService.OpenTestWindow()
export const GetFiveHoleCalibInfo = (probeID: string) => FiveHoleService.GetFiveHoleCalibInfo(probeID)
export const GetFiveHoleTraversalStatus = () => FiveHoleService.GetFiveHoleTraversalStatus()
export const IsFiveHoleCalibLoaded = (probeID: string) => FiveHoleService.IsFiveHoleCalibLoaded(probeID)
export const LoadFiveHoleCalibFiles = (probeID: string, filePaths: string[]) => FiveHoleService.LoadFiveHoleCalibFiles(probeID, filePaths)
export const LoadFiveHoleConfig = () => FiveHoleService.LoadFiveHoleConfig()
export const PauseFiveHoleTraversal = () => FiveHoleService.PauseFiveHoleTraversal()
export const ResumeFiveHoleTraversal = () => FiveHoleService.ResumeFiveHoleTraversal()
export const SaveFiveHoleConfig = (config: FiveHoleTraversalConfig) => FiveHoleService.SaveFiveHoleConfig(config)
export const SelectAndStartFiveHoleRealtimeRecording = () => FiveHoleService.SelectAndStartFiveHoleRealtimeRecording()
export const SelectFiveHoleCalibFiles = () => FiveHoleService.SelectFiveHoleCalibFiles()
export const StartFiveHoleRealtimeMonitor = (config: FiveHoleTraversalConfig) => FiveHoleService.StartFiveHoleRealtimeMonitor(config)
export const StartFiveHoleTraversal = (config: FiveHoleTraversalConfig) => FiveHoleService.StartFiveHoleTraversal(config)
export const StopFiveHoleRealtimeMonitor = () => FiveHoleService.StopFiveHoleRealtimeMonitor()
export const StopFiveHoleRealtimeRecording = () => FiveHoleService.StopFiveHoleRealtimeRecording()
export const IsFiveHoleRealtimeRecording = () => FiveHoleService.IsFiveHoleRealtimeRecording()
export const StopFiveHoleTraversal = () => FiveHoleService.StopFiveHoleTraversal()
...
export const SetThermocoupleType = (id: string, tcTypes: string) => DeviceService.SetThermocoupleType(id, tcTypes)
export const SetSingleThermocoupleType = (id: string, channelIndex: number, tcType: string) => DeviceService.SetSingleThermocoupleType(id, channelIndex, tcType)
...
export const SelectAndStartThreeHoleRealtimeRecording = (probeID = defaultProbeID) => ThreeHoleService.SelectAndStartThreeHoleRealtimeRecording(probeID)
