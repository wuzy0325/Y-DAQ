...
export class FiveHoleCalibFileInfo {
    ...
    constructor($$source: Partial<FiveHoleCalibFileInfo> = {}) {
        ...
        if (!("validRange" in $$source)) {
            this["validRange"] = (new FiveHoleCalibRange());
        }
 ...
 */
export class FiveHoleCalibRange {
    /**
     * 最小攻角（度）
     */
    "alphaMin": number;
    ...
    /** Creates a new FiveHoleCalibRange instance. */
    constructor($$source: Partial<FiveHoleCalibRange> = {}) {
    ...
    /**
     * Creates a new FiveHoleCalibRange instance from a string or object.
     */
    static createFrom($$source: any = {}): FiveHoleCalibRange {
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
        return new FiveHoleCalibRange($$parsedSource as Partial<FiveHoleCalibRange>);
    }
}
...
export class FiveHoleInterpolationResult {
    ...
    constructor($$source: Partial<FiveHoleInterpolationResult> = {}) {
        ...
        if (!("casProbe" in $$source)) {
            this["casProbe"] = 0;
        }
        if (!("satProbe" in $$source)) {
            this["satProbe"] = 0;
        }
        ...
        if (!("vxProbe" in $$source)) {
            this["vxProbe"] = 0;
        }
        if (!("vyProbe" in $$source)) {
            this["vyProbe"] = 0;
        }
        if (!("vzProbe" in $$source)) {
            this["vzProbe"] = 0;
        }
        if (!("valid" in $$source)) {
            this["valid"] = false;
